...
CREATE TABLE `tm_departamentos` (
  `id` varchar(2) NOT NULL,
  `name` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `tm_departamentos`
--

INSERT INTO `tm_departamentos` (`id`, `name`) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
--
-- Estructura de tabla para la tabla `tm_distritos`
--

CREATE TABLE `tm_distritos` (
...
--
-- Volcado de datos para la tabla `tm_distritos`
--

INSERT INTO `tm_distritos` (`id`, `name`, `province_id`, `department_id`) VALUES
...
--
-- Estructura de tabla para la tabla `tm_provincias`
--

CREATE TABLE `tm_provincias` (
...
--
-- Volcado de datos para la tabla `tm_provincias`
--

INSERT INTO `tm_provincias` (`id`, `name`, `department_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
--
-- Indices de la tabla `tm_departamentos`
--
ALTER TABLE `tm_departamentos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tm_distritos`
--
ALTER TABLE `tm_distritos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tm_provincias`
--
ALTER TABLE `tm_provincias`
  ADD PRIMARY KEY (`id`);
COMMIT;
